...
$(document).ready(function(){
	...
	$('.li').click(function(){
		if(!$(this).hasClass('active'))
		{
			...
			$(this).parent().parent().siblings('.slide_now').val(img);
			var bg = "url('"+prefix+"img/"+slider+"/img"+img+".jpg') no-repeat";
			$(this).parent().parent().siblings('.slide_wrapp').children('.slide').animate({opacity: 0}, 500, function(){
				$(this).css('background', bg);
			});
			$(this).parent().parent().siblings('.slide_wrapp').children('.slide').animate({opacity: 1}, 500);
...
$(document).ready(function() {
    ...
    var set_scroll = function (scroll_from, scroll_to, offset) {
  	...
  	set_scroll('.m1', '#n1', 68);
  	set_scroll('.m2', '#n5', 80);
  	set_scroll('.m3', '#n10', 60);
  	set_scroll('.m4', '#n11', 60);
  	set_scroll('.m5', '#n12', 95);
  	set_scroll('.m6', '#n13', 68);
  	set_scroll('.m7', '#map', 68);
    ...
    $('.wrap').each(function() {
   	...
   	(function() {
		var form_top = $('#main_menu').offset().top;
		$(window).scroll(function() {
			var scroll_top = $(this).scrollTop();
			if (scroll_top > form_top) {
				$('#main_menu').css('top', 0).css('position', 'fixed');
			} else {
				$('#main_menu').css('top', '').css('position', '');
			}
		});
	})();
    

    $('.banersis').click(function() {
            //categories            
            var categories = $(this).attr('dir'); 
            var categories = 'images/'+categories+'/';
            var namefile = 'image';
            var endfile = '.jpg';
            var clickId = this.id;
            var bigid = $(this).parent().parent().find(".big-img");
            var bgurl = "url('../"+categories+namefile+clickId+endfile+"') no-repeat";
            var preid = $(this).parent().parent().find(".preload");
            preid.css('background', bgurl);
            bigid.animate({opacity: 0}, 700,
            (function(){
                bigid.attr("src",categories+namefile+clickId+endfile);
                //bigid.css("background",categories+namefile+clickId+endfile); 
                //var bgurl = "url('../"+categories+namefile+clickId+endfile+"') no-repeat";            
                bigid.css('background', bgurl);              
                bigid.animate({opacity: 1}, 700 );
                //bigid.animate({backgound: 'none'}, 500 ); 
            }) );
            $(".banersis").removeClass('activ');
            $(this).addClass("activ");
	  		//$(this).trigger.show();
	  		//$('.popup').fadeIn();
	...
	show_popup('button,.forma_zakaza');    
    
    $('.popup .popup-shadow, .overlay, .close').click(function() {
  		$('.popup').fadeOut(function() {
  			$('.popup-content>*').hide();
    ...
    jQuery('.scroll-animate').each(function () {
		...
		jQuery(window).scroll(function() {
			...
			var bottom = block.height()+top+20000;
...
/*    jQuery('.scroll-animate').each(function () {
		var block = jQuery(this);
		jQuery(window).scroll(function() {
			var top = block.offset().top+00;
			var bottom = block.height()+top+000;
			top = top - jQuery(window).height();
			var scroll_top = jQuery(this).scrollTop();
			if ((scroll_top > top) && (scroll_top < bottom)) {
				if (!block.hasClass('animate')) {
...
function resizePage(){
    ...
    jQuery('body').removeClass('small').removeClass('medium').addClass("full");
...
jQuery(document).ready(function(){ 
  ...
  if(iWidth < 1280){
		jQuery('body').removeClass('full').addClass("small");
        jQuery('.n91_1 .form').css('opacity','1');
        jQuery('.n9_1 .form').css('opacity','1');
        jQuery('.map .form-holder3').css('opacity','1');
        jQuery('.n6_1 .animate').css('opacity','1');
        jQuery('.n8_1 .animate').css('opacity','1');
        jQuery('.n12_1 .n12_1_b').css('opacity','1');
        jQuery('.n12_1 .baneres2 .animate').css('opacity','1');
        jQuery('.n12_1 .baneres .animate').css('opacity','1');
        jQuery('.n11_1 .baneres .ka_baneres').css('opacity','1');
        
  } else if (iWidth > 1280){
		jQuery('body').removeClass('small').addClass("full");	
        
     jQuery('.n11_1 .baneres').on('animateIn', function() {
		var inter = 1;
		jQuery(this).find('.ka_baneres').each(function() {
			var block = jQuery(this);
			setTimeout(function() {
				block.css('opacity', 1);
	...
	/*}).on('animateOut', function() {
     ...
     jQuery('.n12_1 .baneres').on('animateIn', function() {
		var inter = 1;
    ...
    jQuery('.n12_1 .baneres2').on('animateIn', function() {
		var inter = 6;
		jQuery(this).find('.animate').each(function() {
			var block = jQuery(this);
			setTimeout(function() {
    ...
    jQuery('.n12_1').on('animateIn', function() {
		var inter = 0;
		jQuery(this).find('.n12_1_b').each(function() {
			var block = jQuery(this);
			setTimeout(function() {
				block.css('opacity', 1);
				block.addClass('slideTop');
			}, inter*2400);
			inter++;
		});
	/*}).on('animateOut', function() {
    ...
    jQuery('.n6_1').on('animateIn', function() {
		var inter = 0;
		jQuery(this).find('.animate').each(function() {
			var block = jQuery(this);
			setTimeout(function() {
				block.css('opacity', 1);
				block.addClass('bounceIn');
			}, inter*320);
			inter++;
		});
	/*}).on('animateOut', function() {
    ...
    jQuery('.n8_1').on('animateIn', function() {
		var inter = 0;
		jQuery(this).find('.animate').each(function() {
			var block = jQuery(this);
			setTimeout(function() {
    ...
    jQuery('.form-holder3').on('animateIn', function() {
		var inter = 0;
    ...
    jQuery('.form').on('animateIn', function() {
		var inter = 0;
		jQuery(this).each(function() {
			var block = jQuery(this);
			setTimeout(function() {
    ...
    $('.ach span').each(function() {
		$(this).attr('data-number', parseInt($(this).text()));
	});
	
	$('.ach').on('animateIn', function() {
		$(this).find('span').each(function() {
			...
			timeout = setInterval(function() {
				if (step == 251) {
					...
					block.text((Math.floor(count*step/251)).toString());
					step++;
				}
			}, 5);
		});
...
function click(slider) {
	$('.'+slider).children('.click').val(true);
	setTimeout(function(){
		$('.'+slider).children('.click').val(false);
	}, 5000);
}
function play(block) {
	if($(block).children('.click').val() == 'false') {
		setInterval(function(){
			var slide_now = $(block).find('.slide_now').val();
			slide_now++;
			if(slide_now > 8)
				slide_now = 1;
			//$('.play').find('.img'+slide_now).click();
			var img = $(block).find('.img'+slide_now).attr('data-img');
			var slider = $(block).find('.img'+slide_now).attr('data-slider');
			var bg = "url('img/"+slider+"/img"+img+".jpg') no-repeat";
			$(block).find('.slide').animate({opacity: 0}, 500, function(){
				$(this).css('background', bg);
			});
			$(block).find('.slide').animate({opacity: 1}, 500);
			$(block).find('.active').removeClass('active');
			$(block).find('.img'+slide_now).addClass('active');
			$(block).children('.slide_now').val(slide_now);
		}, 3000);
	}
}

//This function sends all emails
function vpb_send_email(type) 
{
	var a = jQuery("#callBack"+type);
	//Variables declaration
	var reg = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/;
	var name = a.find('.input_name').val();
	var phone1 = a.find('.input_phone1').val();
    var phone2 = a.find('.input_phone2').val();
    var phone3 = a.find('.input_phone3').val();
	var email = a.find('.email').val();
    var message = a.find('.long').val();
	var attachedfile =  a.find('.add-file').val('');
	
	//Validation process begins
	if( name == "" )
	{
		a.find('.input_name').css('border', '1px solid #ff7f40');
		a.find(".input_name").focus();
		return false;
	}
	else if( phone1 == "" )
	{
		a.find('.input_name').removeAttr('style');
		a.find('.input_phone1').css('border', '1px solid #ff7f40');
		a.find(".input_phone1").focus();
		return false;
	}
    else if( phone2 == "" )
	{
		a.find('.input_name').removeAttr('style');
        a.find('.input_phone1').removeAttr('style');
		a.find('.input_phone2').css('border', '1px solid #ff7f40');
		a.find(".input_phone2").focus();
		return false;
	}
    else if( phone3 == "" )
	{
		a.find('.input_name').removeAttr('style');
        a.find('.input_phone1').removeAttr('style');
        a.find('.input_phone2').removeAttr('style');
		a.find('.input_phone3').css('border', '1px solid #ff7f40');
		a.find(".input_phone3").focus();
		return false;
	}
	else
	{
        ...
        a.find('.input_phone1').removeAttr('style');
        a.find('.input_phone2').removeAttr('style');
        a.find('.input_phone3').removeAttr('style');
		var dataString = "name=" + name +  "&phone=" + phone1 + phone2 + phone3;
		...
		jQuery.ajax({
			...
			success: function(response)
			{
				...
				if (response_brought != 1) 
				{
                    ...
                    a.find('.email').val('');
					a.find('.fphone').val('');
                    jQuery(".send-pop").fadeOut();					
					jQuery(".overlay").fadeIn();					
					jQuery(".thankBox").fadeIn();			
					//yaCounter23242354.reachGoal('order');
					setTimeout(' jQuery(".thankBox, .overlay").fadeOut();', 2000);	
                    //setTimeout( 'location="order.htm";', 2000 );				
				}
				else
				{					
					a.each(function(){
		...
		var countdown = function() {
	      ...
	      if ($.fn.countdown && count.length) {
			var currentDate = new Date(),
				finishDate = currentDate.setDate(currentDate.getDate() + 4);

	        count.countdown(finishDate, function (event) {
	          var $this = $(this);
	          switch (event.type) {
	          case "seconds":
	          case "minutes":
