$(function() {
	...
	$('.faq__element').click(function() {
		$(this).toggleClass('faq__element--active');
	});
...
const persons = [
	{
	  name: "Lala Talishinskaya",
	  photo: "./img/photo.png",
	  title: "Master of Sports in sports acrobatics",
	  bio:
		"<p>She graduated from Azerbaijan State Academy of Physical Education and Sport. Lala is also a candidate in Masters of Sport in acrobatic track. She was a finalist in the 2015 European Games and a cup winner of the  2016 Aerobics World Cup. Lala also took part in 2018 Aerobic GymnasticsWorld Championship. She has over 4 years of working experience with children. She is full of energy, drive and fun! She also has successfully completed a “First Aid” training programme.</p>",
	  social: {
		facebook: "#",
