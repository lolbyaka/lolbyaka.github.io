...
<html lang="ru">
 <head>
  ...
  <title>Masaa - 30 мастер-классов о здоровье</title>
  <!--[if lt IE 9]>
  <script src="../specsale/js/html5shiv.min.js"></script>
  <![endif]-->
 </head>
 <body>
        ...
        <div class="bl_txt bl-rt">
          <div class="wrap-supply">
            <div class="header-supply">
              <h2>30 мастер-классов<br>о здоровье<span class="txt-orn">На пути к прекрасному самочувствию</span></h2>
            </div>
    ...
    <section class="expert" id="expert">
      <div class="content">
        <div class="content">
          ...
          <div class="bl_txt bl-rt">
            <div class="profile hidden showed_m">— Биолог. Естествоиспытатель. Веган – Сыроед.Ихтиолог.</div>
            <div class="name hidden showed_m">Фролов Юрий</div>
            <div class="txt"><span>С</span>егодня о здоровье говорят много. Увы, не всегда правду. Вам необязательно все это читать и слушать. Избыточное потребление информации вряд ли сделает вас здоровее. «Информационная диета» окажется куда полезней. А в качестве справочника по теме здоровья рекомендую использовать комплект записей конференции. Здесь освещены основные аспекты здорового образа жизни, профилактики и лечения болезней, восстановления молодости и красоты. .
            </div>
            <div class="name showed hidden_m">Фролов Юрий</div>
            <div class="profile showed hidden_m">— Биолог. Естествоиспытатель. Веган – Сыроед.Ихтиолог. Автор статей, фильмов, сайтов, форумов и персонального Блога. Создатель глобального проекта в Пушкинских Горах –просветительского многопрофильного аграрно – оздоровительного центра.</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="block_discount">
      <div class="content">
        <div class="bl-lt do_order_discount">
          <h2>30 мастер-классов по <span class="txt-orn">здоровому образу жизни</span>
              ...
              <div class="block_timer">
                  <div id="countdown_dashboard" class="countdown">
                      <div class="dash days_dash">
                          ...
                          <div class="digit">0</div>
                          <div class="dash_title">дней</div>
                      </div>
                      <div class="dash hours_dash">
                          <div class="digit">0</div>
                          <div class="digit">0</div>
                          <div class="dash_title">часов</div>
                      </div>
                      <div class="dash minutes_dash">
                          <div class="digit">0</div>
                          <div class="digit">0</div>
                          <div class="dash_title">минут</div>
                      </div>
                      <div class="dash seconds_dash">
                          <div class="digit">0</div>
                          <div class="digit">0</div>
                          <div class="dash_title">секунд</div>
                      </div>
                  </div>
              </div>
